...
echo "EiOuDonkey发布脚本,v0.0.114514";
echo -n "输入此次发布的版本号:";
read -r version;
...
if [[ "$choice" == "Y" ]] || [[ "$choice" == "y" ]];then
    ...
    cp -i -a ./Resources "./bin/Release/specific/""$version""/Resources" ;
else
    ...
    if [[ "$release_x86" == "Y"  ]] || [[ "$release_x86" == "y" ]] ;then
        ...
        cp -i -a ./Resources ./bin/Release/win-x86/net7.0/"$version"/Resources;
    fi;
    echo "正在发布win-x64..."
    ...
    cp -i -a ./Resources ./bin/Release/linux-x64/net7.0/"$version"/Resources;
    ...
    cp -i -a ./Resources ./bin/Release/osx-x64/net7.0/"$version"/Resources;
